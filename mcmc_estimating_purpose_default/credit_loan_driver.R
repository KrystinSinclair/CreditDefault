...
mcmcCoda = genMCMC(data=df, sName="Purpose", yName="Credit_default", numSavedSteps=50000 , saveName=fileNameRoot )
#------------------------------------------------------------------------------- 
...
summaryInfo = smryMCMC_Kappa_Omega( mcmcCoda , compVal=NULL , #rope=c(0.45,0.55) ,
                        compValDiff=0.0 ,  diffIdVec=seq(1,10), #ropeDiff = c(-0.05,0.05) ,
                        saveName=fileNameRoot )
# Display posterior information:

plotMCMC_Kappa_Omega( mcmcCoda , data=df , compVal=NULL , sName="Purpose" , yName="Credit_default", #rope=c(0.45,0.55) ,
          compValDiff=0.0 ,  diffIdVec=seq(1,10), #ropeDiff = c(-0.05,0.05) ,
          saveName=fileNameRoot , saveType=graphFileType )
#------------------------------------------------------------------------------- 
