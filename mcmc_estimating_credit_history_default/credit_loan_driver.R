...
mcmcCoda = genMCMC(data=df, sName="Credit_history", yName="Credit_default", numSavedSteps=50000 , saveName=fileNameRoot )
#------------------------------------------------------------------------------- 
...
plotMCMC_Kappa_Omega( mcmcCoda , data=df , compVal=0.5 , sName="Credit_history" , yName="Credit_default", #rope=c(0.45,0.55) ,
          compValDiff=0.0 ,  diffIdVec=seq(1,5), #ropeDiff = c(-0.05,0.05) ,
          saveName=fileNameRoot , saveType=graphFileType )
#------------------------------------------------------------------------------- 
